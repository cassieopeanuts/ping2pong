...
| `Patterns.md` | Entry types, link types, CRUD, cross-zome calls, validation, HDK 0.7 API (GetStrategy, LinkQuery, Local vs Network), must_get, signals (remote signal, init cap grant) |
